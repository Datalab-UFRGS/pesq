...
<head>
  ...
  ?>
  <title>Manual do Pesq | Manual do Dashboard</title>
  <meta name="generator" content="Jekyll v4.2.1" />
  <meta property="og:title" content="Manual do Dashboard do Pesq" />
  <meta property="og:locale" content="en_US" />
  <meta name="description" content="Manual do Dashboard do Pesq" />
  <meta property="og:description" content="Manual do Dashboard do Pesq" />
  <link rel="canonical" href="https://pesq.ufrgs.br/predash.php" />
  <meta property="og:url" content="https://pesq.ufrgs.br/predash.php" />
  <meta property="og:site_name" content="Manual do Dashboard do Pesq" />
  <meta name="twitter:card" content="summary" />
  <meta property="twitter:title" content="Manual do Dashboard do Pesq" />
  <script type="application/ld+json">
  {
    "@type": "WebPage",
    "description": "Manual do Dashboard do Pesq",
    "url": "https://pesq.ufrgs.br/predash.php",
    "headline": "Manual do Dashboard do Pesq",
...
<body data-theme="<?php echo $theme; ?>" class="">
  ...
  <main class="p-predash-main">
    ...
    <p class="t t-center">O Pesq utiliza a ferramenta Elastic Search para oferecer um poderoso dashboard com dados
