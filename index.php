    ...
    <main class="p-home-wrapper" id="home">
        <transition name="homeeffect">
            <div class="c-tips" v-if="showTips">
                ...
                <p>O botão <img class="c-manual-img__in-text" src="<?php echo $url_base ?>/inc/images/manual/btn_busca_avancada.png" alt="botão alternar para busca avançada" height="28px" />, que se
                ...
                <p>O botão <img class="c-manual-img__in-text" src="<?php echo $url_base ?>/inc/images/manual/btn_mostrar_pesquisa_categoria.png" alt="botão mostrar persquisa por categoria" height="28px" /> lista as produções classificados
            ...
            <form class="p-home-form" class="" action="result.php" title="Pesquisa simples" method="post">
                ...
                <transition name="homeeffect">
                    <div class="dv" v-if="searchPage == 'advanced'">
                        ...
                        <div class="dh d-hc">
                            <input type="text" class="c-input--date" id="initialYear" name="initialYear" pattern="\d{4}" placeholder="Ano inicial" />

                            <input type="text" class="c-input--date" id="finalYear" name="finalYear" pattern="\d{4}" placeholder="Ano final" />
                        </div>
